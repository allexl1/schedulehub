...
export default function FloatingNav({ activeTab, setActiveTab }) {
  ...
  const navItems = [
    {
      id: 'home',
      label: t('nav.home') !== 'nav.home' ? t('nav.home') : 'Home',
      icon: 'home'
    },
    {
      id: 'schedule',
      label: t('nav.schedule') !== 'nav.schedule'
        ? t('nav.schedule')
        : 'Schedule',
      icon: 'schedule'
    },
    {
      id: 'teachers',
      label: t('nav.teachers') !== 'nav.teachers'
        ? t('nav.teachers')
        : 'Teachers',
      icon: 'teachers'
    },
    ...
    {
      id: 'settings',
      label: t('nav.settings') !== 'nav.settings'
        ? t('nav.settings')
        : 'Settings',
      icon: 'settings'
    }
