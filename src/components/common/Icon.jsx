...
const icons = {
  ...
  teachers: (
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.8}
      d="M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm8.1 3.5a6.8 6.8 0 0 0-.1-1l2-1.5-2-3.4-2.3.9a7 7 0 0 0-1.7-1L15.7 3h-3.9l-.3 3a7 7 0 0 0-1.7 1l-2.3-.9-2 3.4 2 1.5a6.8 6.8 0 0 0 0 2l-2 1.5 2 3.4 2.3-.9a7 7 0 0 0 1.7 1l.3 3h3.9l.3-3a7 7 0 0 0 1.7-1l2.3.9 2-3.4-2-1.5c.1-.3.1-.7.1-1Z"
    />
  ),
